...
let s:cyan = [ s:none, 6 ]
let s:bcyan = [ s:none, 22 ]
let s:yellow = [ s:none, 3 ]
let s:byellow = [ s:none, 19 ]
let s:brightyellow = [ s:none, 11 ]
let s:blue = [ s:none, 4 ]
...
let s:p.normal.middle = [ [ s:mid, s:tinted ] ]
let s:p.normal.right = [ [ s:black, s:green ], [ s:mid, s:shaded ] ]
let s:p.command.left = [ [ s:cyan, s:bcyan ], [ s:mid, s:shaded ] ]
let s:p.command.middle = [ [ s:mid, s:bcyan ] ]
let s:p.command.right = [ [ s:black, s:green ], [ s:mid, s:shaded ] ]
let s:p.inactive.left =  [ [ s:dim, s:shaded ], [ s:tinted, s:shaded ] ]
let s:p.inactive.middle = [ [ s:dim, s:tinted ] ]
let s:p.inactive.right = [ [ s:dim, s:shaded ] ]
...
let s:p.tabline.left = [ [ s:mid, s:shaded ] ]
let s:p.tabline.tabsel = [ [ s:dark, s:tinted] ]
let s:p.tabline.middle = [ [ s:white, s:tinted ] ]
let s:p.tabline.right = [ [ s:dark, s:transparent ] ]
let s:p.normal.error = [ [ s:black, s:red ] ]
let s:p.normal.warning = [ [ s:brightyellow, s:byellow ] ]
