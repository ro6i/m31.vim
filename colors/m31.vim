...
call s:h("CursorColumn",   s:none, 234)
call s:h("CursorLine",     s:none, 234)
call s:h("Directory",      s:blue)
call s:h("DiffAdd",        s:none, 17)
call s:h("DiffChange",     s:none, 18)
call s:h("DiffDelete",     s:red, 16)
call s:h("DiffText",       s:dark, s:_yellow)
