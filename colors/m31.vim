...
call s:h("Macro",          s:m())
call s:h("Normal",         s:w())
call s:h("Number",         s:r($THEME_OCTETS < 6 ? 1 : 4))
...
call s:h("MatchParen",     s:n, s:m(2), "underline")
call s:h("ModeMsg",        s:y())
call s:h("MoreMsg",        s:r())
call s:h("MsgArea",        s:d(1))
...
call s:h("Search",         s:w(1), s:n, "reverse")
