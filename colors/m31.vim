...
call s:h("ColorColumn",    s:none, 32)
call s:h("Conceal",        s:none, s:none)
call s:h("Cursor",         s:_dark, s:blue)
call s:h("CursorColumn",   s:none, 32)
call s:h("CursorLine",     s:none, 32)
call s:h("Directory",      s:blue)
call s:h("DiffAdd",        s:none, 82)
call s:h("DiffChange",     s:none, 83)
call s:h("DiffDelete",     s:red,  81)
